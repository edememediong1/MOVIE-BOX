...
function MovieCard({movie, selectMovie}){
  ...
  return (
    ...
    >
      {movie.poster_path ? (<img src={`${IMAGE_PATH}${movie.poster_path}`} data-testid="movie-poster" alt="movie-poster" width={250} height={370}/>) : ( <div className="placeholder"> No image Found</div>)}
